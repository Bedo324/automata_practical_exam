...
def nfa_to_dfa(nfa):
    ...
    print("DFA State Mapping:")
    print(f"A = {sorted(dfa_start)}")
    ...
    while unmarked_states:
        ...
        for symbol in alphabet:
            ...
            if closure_frozen not in dfa_states_map:
                state_name = chr(state_name_counter)
                dfa_states_map[closure_frozen] = state_name
                print(f"{state_name} = {sorted(closure)}")
